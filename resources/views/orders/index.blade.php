...
@section('content')
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-danger" style="color: white; border: 1px solid black;">Place order for customer</div>
                ...
                <form class="form-inline my-2 m" method="POST" action="{{ route('orders.store') }}">
                  ...
                  <table class="table table-bordered table-hover bg-success text-white">
                                  <thead >
                                    <tr>
                                      <!-- <th>Id</th> -->
                                      <th>Cloth name</th>
