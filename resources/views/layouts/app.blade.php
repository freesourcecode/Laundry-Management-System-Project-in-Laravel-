...
<footer class="my-5 pt-5 text-muted text-center text-small" style="height: 20px;">
     <ul class="list-inline">
      <li class="list-inline-item"><a href="#">Laundry Management System @2022. All Rights Reserved</a></li>
      <li class="list-inline-item"><a href="https://itsourcecode.com">Itsourcecode.com</a></li>
    </ul>
  </footer>
</html>
